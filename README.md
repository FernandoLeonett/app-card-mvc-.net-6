...
Clona el repositorio de la aplicación en tu ordenador local.
Ejecuta el script de SQL proporcionado para crear las bases de datos y tablas necesarias para la aplicación. Este script también incluye algunas tarjetas precargadas para facilitar la prueba de la aplicación.
