            ...
            var cards = new List<Card>
{
    ...
    new Card { Title = "Bird", Description = "Take pictures of the colorful birds in the park lorem ipsusmmasasa jjasasas hhhh sss jjja kkkkas ljjjnlas fernando jose hernandez leonett es el mejor con chat gpt", Id = 4, UrlImage = "~/img/bird.jpg", DataSource = DataSource.CHRISTMAS }
};
